...
class Iosrpgcrawler(CrawlSpider):
    ...
    start_urls = ['https://apps.apple.com/us/genre/ios-games-role-playing/id7014?letter=A']

    rules = (
        # paginate by letter
        Rule(LinkExtractor(allow = 'genre/ios-games-role-playing/id7014\?letter=(\D)')),
        # paginate to next page
        Rule(LinkExtractor(allow = 'genre/ios-games-role-playing/id7014\?letter=(\D)&page=(\d+)#page', restrict_xpaths = '//a[@class="paginate-more"]')),
